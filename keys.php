...
<body>
	...
	<div class='container content'>
		...
		<?php	
			echo "<h2>Application Name : ".$app_name."</h2>";
		?>
		<ul class="nav nav-tabs">
		<?php 
			echo "<li role='presentation'><a href='details.php'>Details</a></li>";
  			echo "<li role='presentation'  ><a href='settings.php'>Settings</a></li>";
			echo "<li role='presentation'  class='active' ><a href='keys.php'>Keys</a></li>";
		 ?>
		</ul>
		<h4><b> Application Settings</b></h4>
		<h5 style='color:grey;'><i>Keep the "Consumer Secret" a secret. This key should never be human-readable in your application.</i></h5>
		<?php 
			echo $description;
			echo "<br>";
